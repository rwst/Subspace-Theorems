...
-- are certified, its own comparator configs. The first is Corvaja–Zannier (Acta Math. 2004).
@[default_target]
...
/-- Corvaja–Zannier 2004 (`CorvajaZannier2004/`): its statements of record, in the flat shape only,
generated by `scripts/make-challenge.py --paper CorvajaZannier2004`; do not edit by hand. -/
lean_lib ChallengeCorvajaZannier2004 where

/-- Corvaja–Zannier 2004, re-exported for comparator: the modules owning its certified
statements. -/
lean_lib SolutionCorvajaZannier2004 where
...
def comparatorConfigs : Array String :=
  #["comparator/std3.json", "comparator/std3-flat.json",
    "comparator/corvaja-zannier-2004.json"]
