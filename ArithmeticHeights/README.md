...
is claimable before Layers 1 and 2 exist, and 5.2 — which needs 3.4, 4.2, 4.5 and the `ℚ`-case of
4.3 — inherits no Layer 1 or 2 dependency through it. ⚠ 3.5 adds nothing either, and in particular
